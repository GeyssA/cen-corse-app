...
3. **Redirect URLs** : liste des URLs autorisées. Ajoute **les deux** (dev et prod) :
   - `http://localhost:3000/auth/callback`
   - `https://ton-domaine.com/auth/callback`  
   (remplace `ton-domaine.com` par ton vrai domaine ; ajoute `https://www.ton-domaine.com/auth/callback` si ton site est accessible avec `www`.)
