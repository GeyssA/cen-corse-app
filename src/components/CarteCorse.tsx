...
// Définition des zones géographiques de la Corse selon le SVG Corse_svg.svg
const zonesCorse = [
  {
    id: 'zone1',
    nom: 'Balagne',
    description: 'Région du nord-ouest de la Corse',
    couleur: '#cdd883',
    activites: [
      {
        type: 'formation',
        titre: 'Formation identification des oiseaux',
        date: '15-16 mars 2024',
        description: 'Session de formation sur l\'identification des oiseaux migrateurs en Balagne',
        statut: 'terminé'
      },
      {
        type: 'benevole',
        titre: 'Nettoyage des plages',
        date: '22 avril 2024',
  ...
  },
  {
    id: 'zone2',
    nom: 'Cap Corse',
    description: 'Péninsule du nord de la Corse',
    couleur: '#f4e14d',
    activites: [
      {
        type: 'evenement',
        titre: 'Salon de l\'environnement - Bastia',
        date: '8-10 septembre 2024',
        description: 'Participation au salon de l\'environnement de Bastia',
        statut: 'programmé'
      }
    ]
  },
  {
    id: 'zone3',
    nom: 'Centre Corse',
    description: 'Cœur montagneux de la Corse',
    couleur: '#bd98bd',
    activites: [
      {
        type: 'formation',
        titre: 'Formation botanique alpine',
  ...
  },
  {
    id: 'zone4',
    nom: 'Région de Corte',
    description: 'Zone centrale autour de Corte',
    couleur: '#9ea3b9',
    activites: [
      {
        type: 'benevole',
        titre: 'Suivi des rapaces',
        date: 'Toute l\'année',
  ...
  },
  {
    ...
    description: 'Zone ouest autour d\'Ajaccio',
    couleur: '#f0956c',
    activites: [
      {
        type: 'formation',
        titre: 'Formation herpétologie',
  ...
  },
  {
    ...
    description: 'Zone sud-ouest de la Corse',
    couleur: '#f2b936',
    activites: [
      {
        type: 'benevole',
        titre: 'Protection des tortues marines',
        date: 'Juin-Août 2024',
  ...
  },
  {
    ...
    description: 'Sud-est de la Corse',
    couleur: '#59c9b5',
    activites: [
      {
        type: 'formation',
        titre: 'Formation zones humides',
  ...
  },
  {
    ...
    description: 'Extrême sud de la Corse',
    couleur: '#6faf59',
    activites: [
      {
        type: 'evenement',
        titre: 'Festival de la biodiversité',
        date: '15-17 juin 2024',
        description: 'Participation au festival de la biodiversité de Bonifacio',
        statut: 'programmé'
      }
    ]
  },
  {
    ...
    description: 'Zone montagneuse du sud',
    couleur: '#ec8258',
    activites: [
      {
        type: 'benevole',
        titre: 'Suivi des espèces endémiques',
        date: 'Toute l\'année',
        description: 'Suivi des populations d\'espèces endémiques du sud',
        statut: 'en cours'
      }
    ]
  }
...
// Types d'activités avec leurs icônes et couleurs
...
// Statuts avec leurs couleurs
const statuts = {
  'programmé': 'bg-yellow-100 text-yellow-800',
...
interface ModalZoneProps {
  zone: typeof zonesCorse[0] | null
  isOpen: boolean
  onClose: () => void
}

const ModalZone: React.FC<ModalZoneProps> = ({ zone, isOpen, onClose }) => {
...
const CarteCorse: React.FC = () => {
  const { theme } = useTheme()
  const [zoneSelectionnee, setZoneSelectionnee] = useState<typeof zonesCorse[0] | null>(null)
  const [modalOuvert, setModalOuvert] = useState(false)
  
  const handleZoneClick = (zone: typeof zonesCorse[0]) => {
  ...
  const handleCloseModal = () => {
    ...
    setTimeout(() => setZoneSelectionnee(null), 300)
  }
  
  return (
    <div className="h-screen w-full relative overflow-hidden">
      {/* Carte de la Corse avec zones cliquables selon le SVG Corse_svg.svg */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full h-full max-w-6xl">
          {/* Votre SVG avec zones cliquables */}
          <div className="relative w-full h-full">
            ...
            >
              <g transform="matrix(1.0318778,0,0,1.0410268,-18.721993,-23.294371)">
                {/* Zone 1 - Balagne */}
                <path
