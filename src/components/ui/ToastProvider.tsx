...
function ToastItem({ toast, onHide }: ToastItemProps) {
  ...
  return (
    <div
      className={`relative flex items-start p-4 border rounded-lg shadow-lg transform transition-all duration-300 ease-in-out animate-slide-in-right ${getToastStyles()}`}
      role="alert"
    >
      {/* Icône */}
