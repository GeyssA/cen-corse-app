...
export default function Toast({
  ...
  return (
    <div
      className={`
        max-w-sm w-full ${config.bgColor} shadow-lg rounded-lg pointer-events-auto
      ...
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-shrink-0 flex">
            <button
              onClick={handleClose}
              className={`inline-flex ${config.textColor} hover:${config.titleColor} focus:outline-none`}
            >
