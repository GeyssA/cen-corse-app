...
export default function ProjetsContent({ showAddModal, setShowAddModal }: ProjetsContentProps) {
          ...
          <div className="animate-fade-in">
            <div className="grid grid-cols-4 gap-4 text-center">
                <button 
                  ...
                  className={`space-y-2 p-3 rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 ${
                    activeFilter === 'all'
