...
function CollaborateursBande() {
  ...
  return (
    <div className={`w-full py-3 px-4 overflow-hidden ${isLight ? 'bg-gray-100/80' : 'bg-gray-800/50'}`}>
      <p className={`text-center text-[11px] font-medium uppercase tracking-widest mb-2 ${isLight ? 'text-gray-500' : 'text-gray-400'}`}>
        Collaborateurs & Partenaires
      </p>
      <div className="relative w-full overflow-hidden">
        <div 
          className="flex gap-8 w-max animate-scroll-logos"
          style={{ width: 'max-content' }}
        >
          {duplicated.map((logo, i) => (
            <div key={i} className="flex-shrink-0 w-10 h-10 flex items-center justify-center">
              <img src={logo.src} alt={logo.alt} className="w-full h-full object-contain opacity-70" />
            </div>
          ))}
        </div>
      </div>
...
function PhotoOfTheDay() {
  ...
  return (
    <div className="relative w-full h-[28vh] min-h-[200px] max-h-[260px] overflow-hidden group">
      <img 
...
function HomeContent() {
  ...
  useEffect(() => {
    ...
    // 1. L'utilisateur est connecté ET a un profil
  ...
  return (
    <ProtectedRoute>
      {/* Header */}
      <div className={`w-full h-16 overflow-hidden touch-action-pan-y border-b ${
        theme === 'light' ? 'bg-white/95 border-gray-200/80 backdrop-blur-sm' : 'glass-effect border-white/10'
        ...
        <div className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-1xl mx-auto px-0 sm:px-3 md:px-5 py-3 h-full flex items-center justify-between w-full">
          <div className="flex items-center">
            <button
              ...
              className={`rounded-2xl flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl ${
                theme === 'light' ? 'bg-white border border-gray-200' : 'bg-white/95'
              }`}
              style={{ 
            ...
            >
              <img src="/Logo_CENCorse.png" alt="CEN Corse" className="w-10/12 h-10/12 object-contain block" />
            </button>
          </div>
      ...
      <div className={`min-h-screen w-full overflow-x-hidden transition-all duration-300 pb-28 ${
        ...
        <main className="max-w-lg mx-auto px-4 pt-5 pb-6 space-y-8 w-full overflow-x-hidden">
          ...
          <section className="!mt-1 mb-2">
            ...
            <a href="https://www.facebook.com/CENcorse" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#1877F2] flex items-center justify-center text-white hover:scale-105 transition-transform">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/cen_corse/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] flex items-center justify-center text-white hover:scale-105 transition-transform">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/company/conservatoire-d-espaces-naturels-corse/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#0A66C2] flex items-center justify-center text-white hover:scale-105 transition-transform">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="https://www.cen-corse.org/" target="_blank" rel="noopener noreferrer" className={`w-9 h-9 rounded-full flex items-center justify-center hover:scale-105 transition-transform bg-white ${theme === 'dark' ? 'border border-gray-600' : ''}`}>
              <img src="/small_cen.png" alt="CEN" className="w-4 h-4 object-contain" />
            </a>
            </div>
          </section>
        </main>
